...
<button type="submit">{editMode ? 'Редактировать проект' : 'Добавить проект'}</button>
</form>
<div>
...
<button onClick={() => handleEditProject(index)}>Редактировать проект</button>
<button onClick={() => handleDeleteProject(index)}>Удалить проект</button>
</li>
))}
</ul>
</div>
